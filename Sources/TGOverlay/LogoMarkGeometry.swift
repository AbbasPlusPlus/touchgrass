// TGOverlay — the TouchGrass mark, parsed once and mapped into whatever rect wants it.
import AppKit
import CoreGraphics
...
/// and the parser are copied: `TGMenuBar.LogoMarkGeometry` (the menu bar icon, the About page,
/// onboarding) and `Support/icon/generate.swift` (the app icon, a standalone script that
/// re-reads the SVG).
